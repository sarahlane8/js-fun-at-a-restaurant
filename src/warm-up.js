...
// variable should be true, otherwise it should be false. You MUST use a// comparison operator.
...
var vegetables = ["Carrot", "Cucumber", "Broccoli", "Onion", "Okra"];
...
// different fruits.
var fruits = ["Apple", "Banana", "Strawberry", "Blueberry", "Watermelon", "Mango", "Pineapple"]
...
// More key value pairs- saleItems: [], priceOfDeliSpecial: float, storeAddress: "string"
